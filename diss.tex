...
\title{Measuring Entropy in Mesoscopic Circuits}
%\subtitle{If you want a subtitle}

\author{Owen Sheekey}

% What is this dissertation for?
\degreetitle{Honours Bachelors of Science}
...
%% files
\hypersetup{
  pdftitle={Entropy in Mesoscopic Circuits  (DRAFT: \today)},
  pdfauthor={Owen Sheekey},
  pdfkeywords={Condensed matter, Mesoscopic physics, Quantum transport, Entropy}
}
